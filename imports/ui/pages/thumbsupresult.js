...
Router.route('/results/thumbsup/:_id', {
  template: 'thumbsupresult',
});

Template.thumbsupresult.onCreated(function() {
...
Template.thumbsupresult.events({
  // insert code here
});
