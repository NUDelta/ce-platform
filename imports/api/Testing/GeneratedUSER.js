export let USERS = {
  cindy: {
    ...
    profile: {
      firstName: "Cindy",
      lastName: "Hu",
      staticAffordances: { pair1: true, mechanismRich: true },
    },
  },
  yvan: {
    username: "yvan",
  ...
  leesha: {
    username: "leesha",
    email: "Leesha@email.com",
    password: "password",
    profile: {
      firstName: "Leesha",
      lastName: "Shah",
      staticAffordances: { pair6: true },
    },
  },
  justin: {
    username: "justin",
  ...
  gobi: {
    username: "gobi",
    email: "Gobi@email.com",
    password: "password",
    profile: {
      firstName: "Gobi",
      lastName: "Dasu",
      staticAffordances: { pair8: true },
    },
  },
  sydney: {
    username: "sydney",
  ...
  hang: {
    ...
    profile: {
      firstName: "Hang",
      lastName: "Yin",
      staticAffordances: { pair9: true },
    },
  },
  parveen: {
    username: "parveen",
    email: "Parveen@email.com",
    password: "password",
    profile: {
      firstName: "Parveen",
      lastName: "Dhanoa",
