import {
  getDetectorUniqueKey,
  addStaticAffordanceToNeeds,
} from "../oce_api_helpers";
import {
  addContribution,
  changeExperienceToPass,
...
export const createSelfIntro = function (pairNum) {
  const selfIntroCompleteCallback = function (sub) {
    ...
    let message =
      "Woo-hoo! You two have completed Self Intro! Tap here to see your results and share what you think!"; //how do I change this so that it doesn't show up until both people finish?

    sendSystemMessage(message, participants, route);
    notify(
      participants,
      sub.iid,
      "See images from you and your partner's self intro!",
      "",
      route
    );
  };
  ...
  const selfIntroCallback = function (sub) {
    ...
    let systemMessage =
      "Your partner just completed Self-Intro! Participate to see their results when you get a chance💬";
    ...
    contributionTypes: [
      {
        ...
        toPass: {
          ...
          instruction:
            "Say hello to your partner for the next 4 days! \
...
export const createWalk = function (pairNum) {
  const walkCompleteCallback = function (sub) {
    ...
    let route = `/apicustomresults/${sub.iid}/${sub.eid}`;
    let message =
      "Woo-hoo! You two have completed the Walk experience! Tap here to see your results and share what you think!"; //how do I change this so that it doesn't show up until both people finish?

    sendSystemMessage(message, participants, route);
    notify(
      participants,
      sub.iid,
      "See images from you and your partner's walk experience!",
      "",
      route
    );
  };
  ...
  const walkCallback = function (sub) {
    ...
    let systemMessage =
      "Your partner just completed the Walk Experience! Participate to see their results when you get a chance🚶‍♂️";
    ...
    contributionTypes: [
      {
        ...
        toPass: {
          ...
          instruction:
            "Pick out and take a picture of a piece of nature around you that makes you happy! Caption your picture with what about it sparks joy",
        },
        numberNeeded: 2,
        notificationDelay: 1,
...
export const createLibraryExp = function (pairNum) {
  const libraryExpCompleteCallback = function (sub) {
    ...
    let route = `/apicustomresults/${sub.iid}/${sub.eid}`;
    let message =
      "Woo-hoo! You two have completed the Library experience! Tap here to see your results and share what you think!";

    sendSystemMessage(message, participants, route);
    notify(
      participants,
      sub.iid,
      "See images from you and your partner's library experience!",
      "",
      route
    );
  };
  ...
  const libraryExpCallback = function (sub) {
    ...
    let systemMessage =
      "Your partner just completed the Library Experience! Participate to see their results when you get a chance🧑‍💻";
    let notifMessage =
      "Hey! Your partner just completed the Library Experience🧑‍💻";
    ...
    contributionTypes: [
      {
        ...
        toPass: {
          ...
          instruction:
            "Working on something outside home? Show us something cool (or motivating) around your study space that is keeping you going (or focused)? Caption it with why it motivates you!",
        },
        numberNeeded: 2,
        notificationDelay: 1,
...
export const createParkExp = function (pairNum) {
  const parkExpCompleteCallback = function (sub) {
    let submissions = Submissions.find({
      iid: sub.iid,
      needName: sub.needName,
    }).fetch();
    ...
    let route = `/apicustomresults/${sub.iid}/${sub.eid}`;
    let message =
      "Woo-hoo! You two have completed the Park experience! Tap here to see your results and share what you think!";

    sendSystemMessage(message, participants, route);
    notify(
      participants,
      sub.iid,
      "See images from you and your partner's park experience!",
      "",
      route
    );
  };

  const parkExpCallback = function (sub) {
    let submissions = Submissions.find({
      iid: sub.iid,
      needName: sub.needName,
    }).fetch();
    ...
    let systemMessage =
      "Your partner just completed the Park Experience! Participate to see their results when you get a chance🧑‍💻";
    let notifMessage = "Hey! Your partner just completed the Park Experience🧑‍💻";
  ...
  let experience = {
    ...
    contributionTypes: [
      {
        needName: `Park${pairNum}`,
        situation: {
          detector: getDetectorUniqueKey(DETECTORS[pairNum].parkExp),
          number: 1,
        },
        toPass: {
          situationDescription: "Enjoying your study session today?",
    ...
    description: "Share your park experience with your new friend!",
    notificationText: "Share your park experience with your new friend!",
    callbacks: [
      {
        trigger: `(cb.needFinished('Park${pairNum}'))`,
        function: parkExpCompleteCallback.toString(),
      },
      {
        trigger: `!(cb.needFinished('Park${pairNum}'))`,
        function: parkExpCallback.toString(),
      },
    ],
    allowRepeatContributions: false,
  };
...
export const createGroceriesExp = function (pairNum) {
  const groceriesExpCompleteCallback = function (sub) {
    ...
    let route = `/apicustomresults/${sub.iid}/${sub.eid}`;
    let message =
      "Woo-hoo! You two have completed the Groceries experience! Tap here to see your results and share what you think!";

    sendSystemMessage(message, participants, route);
    notify(
      participants,
      sub.iid,
      "See images from you and your partner's groceries experience!",
      "",
      route
    );
  };
  ...
  const groceriesExpCallback = function (sub) {
    ...
    let systemMessage =
      "Your partner just completed the Groceries Experience! Participate to see their results when you get a chance🛒";
    let notifMessage =
      "Hey! Your partner just completed the Groceries Experience🛒";
    ...
    contributionTypes: [
      {
        ...
        toPass: {
          ...
          instruction:
            "What is your game plan for shopping for food? Show us what ingredients you’re using! Caption your picture with your plan!",
        },
        numberNeeded: 2,
        notificationDelay: 1,
        numberAllowedToParticipateAtSameTime: 3,
...
export const createRestaurantExp = function (pairNum) {
  const restaurantExpCompleteCallback = function (sub) {
    ...
    let route = `/apicustomresults/${sub.iid}/${sub.eid}`;
    let message =
      "Woo-hoo! You two have completed the Restaurant experience! Tap here to see your results and share what you think!";

    sendSystemMessage(message, participants, route);
    notify(
      participants,
      sub.iid,
      "See images from you and your partner's restaurant experience!",
      "",
      route
    );
  };
  ...
  const restaurantExpCallback = function (sub) {
    ...
    partner = partner.map((u) => u._id);
    let systemMessage =
      "Your partner just completed the Restaurant Experience! Participate to see their results when you get a chance🍝";
    let notifMessage =
      "Hey! Your partner just completed the Restaurant Experience🍝 ";
    ...
    contributionTypes: [
      {
        ...
        toPass: {
          situationDescription:
            "Enjoying your food and ambience of the restaurant?",
          instruction:
            "Where are you sitting in the restaurant? Why? Take a picture of your place and tell us your reason!",
        },
        numberNeeded: 2,
        notificationDelay: 1,
        numberAllowedToParticipateAtSameTime: 3,
...
export const createGymExp = function (pairNum) {
  const gymExpCompleteCallback = function (sub) {
    ...
    let route = `/apicustomresults/${sub.iid}/${sub.eid}`;
    let message =
      "Woo-hoo! You two have completed the Gym experience! Tap here to see your results and share what you think!";

    sendSystemMessage(message, participants, route);
    notify(
      participants,
      sub.iid,
      "See images from you and your partner's gym experience!",
      "",
      route
    );
  };
  ...
  const gymExpCallback = function (sub) {
    ...
    partner = partner.map((u) => u._id);
    let systemMessage =
      "Your partner just completed the Gym Experience! Participate to see their results when you get a chance🏃";
    ...
    contributionTypes: [
      {
        ...
        toPass: {
          ...
          instruction:
            "How was your workout session today? What keeps you motivated to workout and why? Take a picture of the gym or your motivation and share it with your partner!",
        },
        numberNeeded: 2,
        notificationDelay: 1,
        numberAllowedToParticipateAtSameTime: 3,
...
export const createPublicTransportExp = function (pairNum) {
  const publicTransportExpCompleteCallback = function (sub) {
    ...
    let route = `/apicustomresults/${sub.iid}/${sub.eid}`;
    let message =
      "Woo-hoo! You two have completed the Public Transportation experience! Tap here to see your results and share what you think!";

    sendSystemMessage(message, participants, route);
    notify(
      participants,
      sub.iid,
      "See images from you and your partner's public transportation experience!",
      "",
      route
    );
  };
  ...
  const publicTransportExpCallback = function (sub) {
    ...
    partner = partner.map((u) => u._id);
    let systemMessage =
      "Your partner just completed the Public Transportation Experience! Participate to see their results when you get a chance🚂";
    let notifMessage =
      "Hey! Your partner just completed the Public Transportation Experience🚂 ";
  ...
  let experience = {
    ...
    contributionTypes: [
      {
        ...
        toPass: {
          ...
          instruction:
            "Take a picture of the view outside the window and share where you are heading to today! What do you do to pass time on public transportation and why?",
        },
        numberNeeded: 2,
        notificationDelay: 1,
        numberAllowedToParticipateAtSameTime: 3,
    ...
    description:
      "Share your public transportation experience with your new friend!",
    notificationText:
      "Share your public transportation experience with your new friend!",
    callbacks: [
      {
...
export const createCoffeeExp = function (pairNum) {
  const coffeeExpCompleteCallback = function (sub) {
    ...
    let route = `/apicustomresults/${sub.iid}/${sub.eid}`;
    let message =
      "Woo-hoo! You two have completed the Coffee Shop experience! Tap here to see your results and share what you think!";

    sendSystemMessage(message, participants, route);
    notify(
      participants,
      sub.iid,
      "See images from you and your partner's coffee shop experience!",
      "",
      route
    );
  };
  ...
  const coffeeExpCallback = function (sub) {
    ...
    partner = partner.map((u) => u._id);
    let systemMessage =
      "Your partner just completed the Coffee Shop Experience! Participate to see their results when you get a chance☕️";
    let notifMessage =
      "Hey! Your partner just completed the Coffee Shop Experience☕️";
    ...
    contributionTypes: [
      {
        ...
        toPass: {
          situationDescription:
            "Are you grabbing a coffee to go or are you staying at the coffee shop?",
          instruction:
            "Where do you usually sit and why? Take a picture of your drink or where you are sitting and share it with your partner!",
        },
        numberNeeded: 2,
        notificationDelay: 1,
        numberAllowedToParticipateAtSameTime: 3,
...
export const createBubbleTeaExp = function (pairNum) {
  const bubbleExpCompleteCallback = function (sub) {
    ...
    let route = `/apicustomresults/${sub.iid}/${sub.eid}`;
    let message =
      "Woo-hoo! You two have completed the Bubble Tea experience! Tap here to see your results and share what you think!";

    sendSystemMessage(message, participants, route);
    notify(
      participants,
      sub.iid,
      "See images from you and your partner's Bubble Tea experience!",
      "",
      route
    );
  };
  ...
  const bubbleExpCallback = function (sub) {
    ...
    partner = partner.map((u) => u._id);
    let systemMessage =
      "Your partner just completed the Bubble Tea Experience! Participate to see their results when you get a chance🧋";
    let notifMessage =
      "Hey! Your partner just completed the Bubble Tea Experience🧋";
    ...
    contributionTypes: [
      {
        ...
        toPass: {
          situationDescription:
            "What brought you to the bubble tea shop today?",
          instruction:
            "What drink did you get and why? Take a picture of your drink and share it with your partner!",
        },
        numberNeeded: 2,
        notificationDelay: 1,
        numberAllowedToParticipateAtSameTime: 3,
...
const creatPairExperience = function (pairNum) {
  return {
    ...
    parkExperience: createParkExp(pairNum),
