...
const convertCNtoCE = function(storyName, storyDescription, storyNotification, generalContext, templates, preStoryInfo, characterRoles) {
...
let EXPERIENCES = {
  murder: convertCNtoCE(title, description, notification, setting, MMtemplates, questions, characters)
};
