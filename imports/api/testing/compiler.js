...
let questio
let preStoryInfo = []
convertCNtoCE("Murder Mystery", "You've been invited to participate in a murder mystery!", "Help us catch a killer!", "coffee", MMtemplates, "")
...
const convertCNtoCE = function(storyName, storyDescription, storyNotification, generalContext, templates, preStoryInfo) {
  ...
  //   } else {
  //     make an array with the info.responseType options
  //   }
