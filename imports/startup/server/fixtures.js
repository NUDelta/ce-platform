...
function createTestData(){
  ...
  let uid5 = findUserByUsername('chris')._id;
  let uid6 = findUserByUsername('richard')._id;
  let uid7 = findUserByUsername('amy')._id;
  let uid8 = findUserByUsername('chase')._id;
  let uid9 = findUserByUsername('will')._id;
  let uid10 = findUserByUsername('eric')._id;
